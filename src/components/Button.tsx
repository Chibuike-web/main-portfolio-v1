...
const buttonVariants = cva(
	"flex items-center justify-between font-semibold cursor-pointer rounded-full focus:outline-0 focus-visible:ring-2 focus-visible:ring-gray-300 focus-visible:ring-offset-2",
	{
		variants: {
			variant: {
