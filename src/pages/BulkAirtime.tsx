	...
	return (
		<main className="w-full max-w-[81rem] mx-auto px-6 xl:px-0 ">
			...
			<LazyImage
				...
				width={1296}
				height={750}
				className="w-full mt-[3.25rem] md:mt-[6.5rem] rounded-[1rem] md:rounded-[2rem]"
			/>
			<LazyImage
				src={seventhImage}
			...
			<LazyImage
				...
				width={1296}
				height={750}
				className="w-full my-[3.25rem] md:my-[6.5rem] rounded-[1rem] md:rounded-[2rem]"
			/>
		</main>
	);
}
